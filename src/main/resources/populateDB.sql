...
insert into projects(id_project,name_project,id_company, id_coustomer) values (31,'Robot Sofia',11,21);
insert into projects(id_project,name_project,id_company, id_coustomer) values (32,'SpaceOf',11,22);
insert into projects(id_project,name_project,id_company, id_coustomer) values (33,'Cyberpunk',12,22);
insert into projects(id_project,name_project,id_company, id_coustomer) 
values (34,'Universe of Luidgy',12,21);
